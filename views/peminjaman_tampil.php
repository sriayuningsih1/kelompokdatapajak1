        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Data Pajak Rumah Makan</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th></th><th>Npwp</th><th>Nama</th><th>Alamat</th><th>Masa Pajak</th><th>Jumlah Pokok Pajak</th><th>ACTIONS</th>
                            </tr>
                        </thead>
                        <tbody>
                  ...
                  <td><?= $data['masa_pajak'] ?> &nbsp <a href="?page=peminjaman&actions=kembaliArsip&nope=<?= $data['npwp'] ?>" class="btn btn-info btn-xs">
