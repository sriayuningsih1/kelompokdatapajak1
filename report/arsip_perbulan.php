...
<html>
    <head>
        <title>Cetak Data Pajak SKPD Perbulan</title>
        <link href="../Assets/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    </head>
    <body onload="print()">
        <!--Menampilkan data detail simpan-->
        <?php
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PAJAK SKPD BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tbl_simpan WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
